    ...
    <div className="space-y-10">
      ...
      <section className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <Surface className="p-5">
          ...
          <p className="mt-2 text-3xl font-semibold text-fg">{totals.all}</p>
        </Surface>
        <Surface className="p-5">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-emerald-600">
            Deleted
          </p>
          <p className="mt-2 text-3xl font-semibold text-fg">{totals.deleted}</p>
        </Surface>
        <Surface className="p-5">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-amber-600">
            Stall
          </p>
          <p className="mt-2 text-3xl font-semibold text-fg">{totals.stall}</p>
        </Surface>
        <Surface className="p-5">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-rose-600">
            Verified (needs re-dispute)
          </p>
          <p className="mt-2 text-3xl font-semibold text-fg">{totals.verified}</p>
        </Surface>
      </section>
